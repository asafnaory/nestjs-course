...
import { handleErrors, isNestException } from '../helpers/helpers';
import { isPrismaError, prismaErrorHandler } from '../prisma/prisma.helpers';
...
export class PlayersService {
  constructor(private prisma: PrismaService, private config: ConfigService) {
    const foo = this.config.get<string>('players.foo');
    console.log(foo);
  }
